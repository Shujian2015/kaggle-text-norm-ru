...
ext_cnt_s = 2   # Ignore external ngram if count less than this number
...
# #### Save to output
test[['id','after']].to_csv('submission_' + str(ngram) + '_e' + str(ngram_ext_s)+ '-' + str(ngram_ext_e) + 'gram-bigdata_ext_cnt_2.csv', index=False)
